...
//dashboards
import NetForestCoverChange from "./ScenathonPrivate/NetForestCoverChange";
import Biodiversity from "./ScenathonPrivate/Biodiversity";
import GlobalTargets from "./ScenathonPrivate/GlobalTargets";
import ProtectedAreaByType from "./ScenathonPrivate/ProtectedAreaByType";
import LandCover from "./ScenathonPrivate/LandCover";
import FoodEnergyIntakePerCapita from "./ScenathonPrivate/FoodEnergyIntakePerCapita";
import FoodEnergyIntakePerCapita2 from "./ScenathonPrivate/FoodEnergyIntakePerCapita2";
import FreshWaterUse from "./ScenathonPrivate/FreshWaterUse";
import NetForestCoverChange2 from "./ScenathonPrivate/NetForestCoverChange2";
import GreenHouse2 from "./ScenathonPrivate/GreenHouse2";
import GreenHouseOne from "./ScenathonPrivate/GreenHouseOne";
import FreshWaterTwo from "./ScenathonPrivate/FreshWaterTwo";
// assets
import TradeReport from "./ScenathonPrivate/TradeReport";
...
const ScenathonPrivate = (props) => {
  console.log("ScenathonPrivate");
  console.log(props);
...
export default withRouter(ScenathonPrivate);
