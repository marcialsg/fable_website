...
const getScenathonMetaData2 = async (client, attribute, table, condition)  => {
  
    var responseMessage = []

    try {
      var query_to_fetch = 'SELECT "'+ attribute +'" FROM ' + table + ' ' + condition;
...
module.exports = getScenathonMetaData2 ;