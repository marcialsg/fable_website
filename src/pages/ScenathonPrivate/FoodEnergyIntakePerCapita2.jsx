...
import BarChart2 from "../../components/ScenathonPrivate/BarChart2.jsx";
import FoodEnergyTwoService from "../../services/ScenathonPrivate/FoodEnergyTwoService";
...
const FoodEnergyIntakePerCapita = (props) => {
  const getTradeAdjusments = function ({ iterations }) {
    ...
    console.log("FoodEnergyIntakePerCapita2 getTradeAdjusments: ", iterations);
    ...
    console.log(
      "FoodEnergyIntakePerCapita2 tradeAdjustmentsList: ",
