...
import FreshWaterTwoService from "../../services/ScenathonPrivate/FreshWaterTwoService";
...
const DrawFreshWater2 = (props) => {
  const getTradeAdjusments = function ({ iterations }) {
    ...
    //console.log("FreshWaterTwo getTradeAdjusments: ", iterations);
    ...
    //console.log("FreshWaterTwo tradeAdjustmentsList: ", tradeAdjustmentsList);
  ...
  const getScenathonId = function (scenathon_label) {
    //console.log(
    //   "FreshWaterTwo getScenathonId scenathon_label: ",
    //   scenathon_label
    // );
